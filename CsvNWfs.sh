...
#elif [[ $NameOf_LastProcessed == *"-union_"* ]]
#then
#NordOuest3857=$(awk -F'|' -v 'NameForUnion'='$NameForUnion' "/$base_name/"  tmp/List_Special_Planches.csv |awk -F'|' '{print $8}')
#SudOuest3857=$(awk -F'|' -v 'NameForUnion'='$NameForUnion' "/$base_name/"  tmp/List_Special_Planches.csv |awk -F'|' '{print $9}')
#SudEst3857=$(awk -F'|' -v 'NameForUnion'='$NameForUnion' "/$base_name/"  tmp/List_Special_Planches.csv |awk -F'|' '{print $10}')
#NordEst3857=$(awk -F'|' -v 'NameForUnion'='$NameForUnion' "/$base_name/"  tmp/List_Special_Planches.csv |awk -F'|' '{print $11}')
#BasicWKT=$(echo "Polygon (($NordOuest3857, $SudOuest3857, $SudEst3857, $NordEst3857, $NordOuest3857))")
#echo "$green -union.. I'm Special -union_* $red(Special Map Extent)"
#
#echo "$purple $NordOuest3857, $SudOuest3857, $SudEst3857, $NordEst3857, $NordOuest3857"
#
#top_left27561=$(awk -F'|' -v 'base_name'='$base_name' "/$base_name/"  tmp/List_Special_Planches.csv |awk -F'|' '{print $4}')
#bottom_left27561=$(awk -F'|' -v 'base_name'='$base_name' "/$base_name/"  tmp/List_Special_Planches.csv |awk -F'|' '{print $5}')
#bottom_right27561=$(awk -F'|' -v 'base_name'='$base_name' "/$base_name/"  tmp/List_Special_Planches.csv |awk -F'|' '{print $6}')
...
#
#echo "$purple
#top_left27561 $top_left27561
#bottom_left27561 $bottom_left27561
#bottom_right27561 $bottom_right27561
#top_right27561 $top_right27561
#$NordOuest4326
#$NordOuest3857
## SW
#$SudOuest4326
...
exiftool -r -overwrite_original -keywords= -m -keywords="$Lastrender|$OriginalPost1980Name|$Seine|$OldNum|$Ouest $Nord|$Ouest $Sud|$Est $Sud|$Est $Nord|$NordOuest3857|$SudOuest3857|$SudEst3857|$NordEst3857|$NordOuest4326|$SudOuest4326|$SudEst4326|$NordEst4326|Polygon (($NordOuest3857, $SudOuest3857, $SudEst3857, $NordEst3857, $NordOuest3857))|$RawMapUri|$RawMapName|$StorageLocation|$PreviewPNGLocation|$Year|$NodeID|$WKT_Map_Extent|$geoserverworkspace|$ZipRawMapUri|$NordOuestBasic2571|$SudOuestBasic2571|$SudEstBasic2571|$NordEstBasic2571|$NordOuestBasic4326|$SudOuestBasic4326|$SudEstBasic4326|$NordEstBasic4326|$NordOuestBasic|$SudOuestBasic|$SudEstBasic|$NordEstBasic|$LastModified_GeoTiff"  -artist="sous-paris.com" -Software="Kta2geo 1.1" ../_Output/"$Lastrender"
echo "$Lastrender|$OriginalPost1980Name|$Seine|$OldNum|$Ouest $Nord|$Ouest $Sud|$Est $Sud|$Est $Nord|$NordOuest3857|$SudOuest3857|$SudEst3857|$NordEst3857|$NordOuest4326|$SudOuest4326|$SudEst4326|$NordEst4326|Polygon (($NordOuest3857, $SudOuest3857, $SudEst3857, $NordEst3857, $NordOuest3857))|$RawMapUri|$RawMapName|$StorageLocation|$PreviewPNGLocation|$Year|$NodeID|$WKT_Map_Extent|$geoserverworkspace|$ZipRawMapUri|$NordOuestBasic2571|$SudOuestBasic2571|$SudEstBasic2571|$NordEstBasic2571|$NordOuestBasic4326|$SudOuestBasic4326|$SudEstBasic4326|$NordEstBasic4326|$NordOuestBasic|$SudOuestBasic|$SudEstBasic|$NordEstBasic|$LastModified_GeoTiff"  > tmp/csv_tmp
else
...
exiftool -r -overwrite_original -keywords= -m -keywords="$Lastrender|$OriginalPost1980Name|$Seine|$OldNum|$InfoSpecialMap|$BasicWKT|$RawMapUri|$RawMapName|$StorageLocation|$PreviewPNGLocation|$Year|$NodeID|$WKT_Map_Extent|$geoserverworkspace|$ZipRawMapUri|$NordOuestBasic2571|$SudOuestBasic2571|$SudEstBasic2571|$NordEstBasic2571|$NordOuestBasic4326|$SudOuestBasic4326|$SudEstBasic4326|$NordEstBasic4326|$NordOuestBasic|$SudOuestBasic|$SudEstBasic|$NordEstBasic|$LastModified_GeoTiff" -artist="sous-paris.com" -Software="Kta2geo 1.1" ../_Output/"$Lastrender"
echo "$Lastrender|$OriginalPost1980Name|$Seine|$OldNum|$InfoSpecialMap|$BasicWKT|$RawMapUri|$RawMapName|$StorageLocation|$PreviewPNGLocation|$Year|$NodeID|$WKT_Map_Extent|$geoserverworkspace|$ZipRawMapUri|$NordOuestBasic2571|$SudOuestBasic2571|$SudEstBasic2571|$NordEstBasic2571|$NordOuestBasic4326|$SudOuestBasic4326|$SudEstBasic4326|$NordEstBasic4326|$NordOuestBasic|$SudOuestBasic|$SudEstBasic|$NordEstBasic|$LastModified_GeoTiff" > tmp/csv_tmp
fi
