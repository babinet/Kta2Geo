...
<qgis labelsEnabled="1" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyMaxScale="1" readOnly="0" styleCategories="AllStyleCategories" maxScale="0" simplifyLocal="1" version="3.16.0-Hannover" simplifyDrawingHints="0" minScale="100000000">
  <flags>
  ...
  <DiagramLayerSettings showAll="1" priority="0" placement="0" dist="0" obstacle="0" linePlacementFlags="18" zIndex="0">
    <properties>
      <Option type="Map">
        <Option name="name" type="QString" value=""/>
        <Option name="properties"/>
